  ...
  */
  switch(mode){
    ...
    text(mode,50,50);
      ...
      textSize(50);
      text("coin",650,40);
      text(moveCoin,650,90);
      text("enemy",650,130);
      text(moveEnemy,650,180);
      //coinDis();
      if(highlow == ans){
        if(moveCoin < coin){
          moveCoin += 1;
...
public void mouseReleased(){
  switch(mode){
    ...
    mode = 2;
    open1 = PApplet.parseInt(random(1,14));
    open2 = PApplet.parseInt(random(1,14));
    bet = 1;
    coin -= 1;
    checkAns();
    }
...
public void deck(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "cardgame" };
    if (passedArgs != null) {
